...
namespace back_end.Controllers
{
    ...
    public class DiagnosedHistoryController : ControllerBase
    {
        ...
        [HttpGet("payBill")]
        public async Task<IActionResult> PayBill()      /*这里后续要改成接收一个diagnoseId的参数*/
        {
            ...
            //商户订单号，商家自定义，保持唯一性
            bizContent.Add("out_trade_no", "20210817010");       /*这里20210817010后续要改成基于diagnoseId生成的订单号*/
            //支付金额，最小值0.01元
            bizContent.Add("total_amount", 12);     /*这里12后续要改成药品收款*/
            //订单标题，不可使用特殊符号
